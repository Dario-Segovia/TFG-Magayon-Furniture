...
<div class="modal-overlay">
  <div class="modal-container">
    <div class="modal-header">
      <h2>Editar Venta</h2>
      <button @click="$emit('cancelar-edicion')" class="close-btn">&times;</button>
    </div>
...
const emit = defineEmits(['actualizar-venta', 'cancelar-edicion']);
...
// Cuando cambia la venta actual, actualizamos el formulario
watch(() => props.ventaActual, (newVal) => {
  if (newVal) {
    venta.value = {
      id_cliente: newVal.id_cliente,
      detalles: [...newVal.detalles]
    };
  }
}, { immediate: true });
